...
- 为了防止实例化展开为无穷副本后导致Segmentation Fault，我们设置了最大指针层数，如需关闭可注释掉lang.c中的#define max_ptr 1000。我们也还做了一个跟C++编译器一样的实现，即设置最大实例化深度，开启方式为取消lang.c中#define ins_depth_limit的注释。
